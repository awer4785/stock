...
if($_POST) {	
  ...
  $description                  = $_POST['description'];
	...
	$sql = "UPDATE orders SET order_date = '$orderDate', client_name = '$clientName', client_contact = '$clientContact',description='$description', sub_total = '$subTotalValue' WHERE order_id = {$orderId}";	
	$connect->query($sql);
